...
enum ValidationRuntime {
    static var isEnabled: Bool {
        ProcessInfo.processInfo.environment["THINGSTRUCT_VALIDATION"] == "1"
    }

    static func participantID(defaults: UserDefaults = .standard) -> UUID {
        let key = "ThingStruct.Validation.ParticipantID"
    ...
    static func defaultLogURL(fileManager: FileManager = .default) -> URL {
        ...
        return root
            .appending(path: "ThingStructValidation", directoryHint: .isDirectory)
